...
| 🐘 `postgres14`   | Base de datos para energía  | `5433`      | `msvc_energy_db`             |
| ⚡ `msvc-users`    | Microservicio de usuarios   | `8001`      | MySQL                        |
| ⚡ `msvc-energy`   | Microservicio de energía    | `8002`      | PostgreSQL                   |
